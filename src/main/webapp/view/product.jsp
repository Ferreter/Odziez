...
<div style="margin: 20px; margin-bottom:100px; margin-top: 50px;">
    <a href="userProfile.jsp" color="text-decoration-none" style="color:white">
...
<div class="container-fluid" style="border-top:5px solid white; ">
    <div class="row" style="margin-top:25px;">
        ...
        <div class="col" style="">
            <a href="#" style="color:white; padding-top: 50px;" class="text-decoration-none">
                <h3> The Showspace </h3>
...
<div class="container" style="margin-bottom: 50px; border-top: 5px solid white" >
    <p class=" text-center h3" style="margin-top:20px;">Coustomer Favourite's</p>
    <div class="row" style="margin-top:25px;">
        <div class="col-lg-3 col-md-3 col-xs-12 ">
            <a href="#" style="color:white;">
                <div class="text-center p-3">
